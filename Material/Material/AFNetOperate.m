...
- (id)getKeyArchive:(NSString *)path key:(NSString *)key {
  ...
  NSDictionary *dictionary =
      [NSKeyedUnarchiver unarchiveObjectWithFile:pathArchive];
...
- (NSString *)baseURL {
  ...
  NSString *document = [documentDictionary firstObject];
  NSString *path =
      [document stringByAppendingPathComponent:@"ip.address.archive"];
...
- (NSString *)part_index {
  ...
  NSString *part =
      [[[self URLDictionary] objectForKey:@"part"] objectForKey:@"root"];
  return [base stringByAppendingString:part];
}
- (NSString *)part_validate {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"part"] objectForKey:@"validate"];
  return [[self part_index] stringByAppendingString:bind];
}
- (NSString *)part_quantity_validate {
  NSString *bind = [[[self URLDictionary] objectForKey:@"xiang"]
      objectForKey:@"validate_quantity"];
...
- (NSString *)xiang_index {
  NSString *base = [self baseURL];
  NSString *xiang =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"root"];
  return [base stringByAppendingString:xiang];
}
- (NSString *)xiang_root {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"index"];
  return [[self xiang_index] stringByAppendingString:bind];
}
...
- (NSString *)xiang_uncheck {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"uncheck"];
  return [[self xiang_index] stringByAppendingString:bind];
}
- (NSString *)xiang_send {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"send"];
  return [[self xiang_index] stringByAppendingString:bind];
}
- (NSString *)xiang_receive {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"receive"];
  return [[self xiang_index] stringByAppendingString:bind];
}
- (NSString *)xiang_reject {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"reject"];
  return [[self xiang_index] stringByAppendingString:bind];
}
- (NSString *)xiang_received {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"xiang"] objectForKey:@"received"];
  return [[self xiang_index] stringByAppendingString:bind];
}
...
- (NSString *)tuo_index {
  NSString *base = [self baseURL];
  NSString *tuo =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"root"];
  return [base stringByAppendingString:tuo];
}
- (NSString *)tuo_root {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"index"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_single {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"single"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_packages {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"packages"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_bundle_add {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"bundle_add"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_key_for_bundle {
  NSString *bind = [[[self URLDictionary] objectForKey:@"tuo"]
      objectForKey:@"key_for_bundle"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_remove_xiang {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"remove_xiang"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_received {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"received"];
  return [[self tuo_index] stringByAppendingString:bind];
}
...
- (NSString *)tuo_receive {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"receive"];
  return [[self tuo_index] stringByAppendingString:bind];
}
- (NSString *)tuo_send {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"tuo"] objectForKey:@"send"];
  return [[self tuo_index] stringByAppendingString:bind];
}
...
- (NSString *)yun_index {
  NSString *base = [self baseURL];
  NSString *yun =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"root"];
  return [base stringByAppendingString:yun];
}
- (NSString *)yun_root {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"index"];
  return [[self yun_index] stringByAppendingString:bind];
}
- (NSString *)yun_single {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"single"];
  return [[self yun_index] stringByAppendingString:bind];
}
- (NSString *)yun_add_tuo_by_scan {
  NSString *bind = [[[self URLDictionary] objectForKey:@"yun"]
      objectForKey:@"add_tuo_by_scan"];
  return [[self yun_index] stringByAppendingString:bind];
}
- (NSString *)yun_remove_tuo {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"remove_tuo"];
  return [[self yun_index] stringByAppendingString:bind];
}
- (NSString *)yun_add_tuo {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"add_tuo"];
  return [[self yun_index] stringByAppendingString:bind];
}
- (NSString *)yun_send {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"send"];
  return [[self yun_index] stringByAppendingString:bind];
}
...
- (NSString *)yun_receive {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"receive"];
  return [[self yun_index] stringByAppendingString:bind];
}
...
- (NSString *)yun_received {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"yun"] objectForKey:@"received"];
  return [[self yun_index] stringByAppendingString:bind];
}
//库
- (NSString *)storages_index {
  NSString *base = [self baseURL];
  NSString *storages =
      [[[self URLDictionary] objectForKey:@"storages"] objectForKey:@"index"];
  return [base stringByAppendingString:storages];
}
- (NSString *)storages_move_store {
  NSString *bind = [[[self URLDictionary] objectForKey:@"storages"]
      objectForKey:@"move_store"];
...
- (NSString *)baseURL_print {
  ...
  NSString *file =
      [[[self URLDictionary] objectForKey:@"print"] objectForKey:@"file"];
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    ...
    NSString *base =
        [[[self URLDictionary] objectForKey:@"print"] objectForKey:@"base"];
    NSString *port =
        [[[self URLDictionary] objectForKey:@"print"] objectForKey:@"port"];
    return [[base stringByAppendingString:port] stringByAppendingString:file];
  }
}
...
- (NSString *)print_model_list {
  ...
  NSString *path =
      [document stringByAppendingPathComponent:@"print.ip.address.archive"];
  NSString *list =
      [[[self URLDictionary] objectForKey:@"print"] objectForKey:@"model"];
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    NSString *base = [dictionary objectForKey:@"print_ip"];
    NSString *port = [dictionary objectForKey:@"print_port"];
...
- (NSString *)get_current_print_model {
  ...
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    return [dictionary objectForKey:@"print_model"]
               ? [dictionary objectForKey:@"print_model"]
               : @"";
  } else {
    return @"";
  }
...
- (void)set_tuo_copy:(NSString *)copy {
  NSDictionary *dictionary =
      [NSDictionary dictionaryWithObjectsAndKeys:copy, @"tuo_copy", nil];
  NSArray *documentDictionary = NSSearchPathForDirectoriesInDomains(
      NSDocumentDirectory, NSUserDomainMask, YES);
  NSString *document = [documentDictionary firstObject];
  NSString *path =
      [document stringByAppendingPathComponent:@"print.copy.tuo.archive"];
  [NSKeyedArchiver archiveRootObject:dictionary toFile:path];
}
- (void)set_yun_copy:(NSString *)copy {
  NSDictionary *dictionary =
      [NSDictionary dictionaryWithObjectsAndKeys:copy, @"yun_copy", nil];
  NSArray *documentDictionary = NSSearchPathForDirectoriesInDomains(
      NSDocumentDirectory, NSUserDomainMask, YES);
  NSString *document = [documentDictionary firstObject];
  NSString *path =
      [document stringByAppendingPathComponent:@"print.copy.yun.archive"];
  [NSKeyedArchiver archiveRootObject:dictionary toFile:path];
}
- (void)set_yun_uncheck_copy:(NSString *)copy {
  NSDictionary *dictionary = [NSDictionary
      dictionaryWithObjectsAndKeys:copy, @"yun_uncheck_copy", nil];
  NSArray *documentDictionary = NSSearchPathForDirectoriesInDomains(
      NSDocumentDirectory, NSUserDomainMask, YES);
  NSString *document = [documentDictionary firstObject];
  NSString *path = [document
      stringByAppendingPathComponent:@"print.copy.yun.uncheck.archive"];
  [NSKeyedArchiver archiveRootObject:dictionary toFile:path];
}
- (void)set_transfer_note_copy:(NSString *)copy {
  NSDictionary *dictionary = [NSDictionary
      dictionaryWithObjectsAndKeys:copy, @"transfer_note_copy", nil];
  NSArray *documentDictionary = NSSearchPathForDirectoriesInDomains(
      NSDocumentDirectory, NSUserDomainMask, YES);
  NSString *document = [documentDictionary firstObject];
  NSString *path = [document
      stringByAppendingPathComponent:@"print.copy.transfer.note.archive"];
  [NSKeyedArchiver archiveRootObject:dictionary toFile:path];
}
- (NSString *)get_tuo_copy {
  ...
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    return [dictionary objectForKey:@"tuo_copy"]
               ? [dictionary objectForKey:@"tuo_copy"]
               : @"1";
  } else {
    return @"1";
  }
...
- (NSString *)get_yun_copy {
  ...
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    return [dictionary objectForKey:@"yun_copy"]
               ? [dictionary objectForKey:@"yun_copy"]
               : @"1";
  } else {
    return @"1";
  }
...
- (NSString *)get_yun_uncheck_copy {
  ...
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    return [dictionary objectForKey:@"yun_uncheck_copy"]
               ? [dictionary objectForKey:@"yun_uncheck_copy"]
               : @"1";
  } else {
    return @"1";
  }
...
- (NSString *)get_transfer_note_copy {
  ...
  if ([NSKeyedUnarchiver unarchiveObjectWithFile:path]) {
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithFile:path];
    return [dictionary objectForKey:@"transfer_note_copy"]
               ? [dictionary objectForKey:@"transfer_note_copy"]
               : @"1";
  } else {
    return @"1";
  }
...
- (NSString *)log_in {
  NSString *base = [self baseURL];
  return [base
      stringByAppendingString:[[self URLDictionary] objectForKey:@"log_in"]];
}
- (NSString *)log_out {
  NSString *base = [self baseURL];
  return [base
      stringByAppendingString:[[self URLDictionary] objectForKey:@"log_out"]];
}
// version
- (NSString *)version {
  NSString *base = [self baseURL];
  return [base
      stringByAppendingString:[[self URLDictionary] objectForKey:@"version"]];
}
#pragma validate
- (NSString *)scan_validate {
  NSString *base = [self baseURL];
  return [base stringByAppendingString:[[self URLDictionary]
                                           objectForKey:@"scan_validate"]];
}
// order
- (NSString *)order_root {
  NSString *base = [self baseURL];
  NSString *order =
      [[[self URLDictionary] objectForKey:@"orders"] objectForKey:@"root"];
  return [base stringByAppendingString:order];
}
- (NSString *)order_history {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"orders"] objectForKey:@"history"];
  return [[self order_root] stringByAppendingString:bind];
}
- (NSString *)order_check_part {
  NSString *bind = [[[self URLDictionary] objectForKey:@"orders"]
      objectForKey:@"check_part"];
  return [[self order_root] stringByAppendingString:bind];
}
// order item
- (NSString *)order_item_root {
  NSString *base = [self baseURL];
  NSString *order_item =
      [[[self URLDictionary] objectForKey:@"order_item"] objectForKey:@"root"];
  return [base stringByAppendingString:order_item];
}
- (NSString *)order_item_verify {
  NSString *bind = [[[self URLDictionary] objectForKey:@"order_item"]
      objectForKey:@"verify"];
...
- (NSString *)order_led_root {
  NSString *base = [self baseURL];
  NSString *order_led =
      [[[self URLDictionary] objectForKey:@"order_led"] objectForKey:@"root"];
  return [base stringByAppendingString:order_led];
}
- (NSString *)order_led_reset {
  NSString *bind =
      [[[self URLDictionary] objectForKey:@"order_led"] objectForKey:@"reset"];
  return [[self order_led_root] stringByAppendingString:bind];
}
- (NSString *)order_led_position_state {
  NSString *bind = [[[self URLDictionary] objectForKey:@"order_led"]
      objectForKey:@"position_state"];
  return [[self order_led_root] stringByAppendingString:bind];
}
- (NSString *)order_led_state_list {
  NSString *bind = [[[self URLDictionary] objectForKey:@"order_led"]
      objectForKey:@"state_list"];
  return [[self order_led_root] stringByAppendingString:bind];
}
...
- (NSString *)locations_warehosues {
  NSString *base = [self baseURL];
  NSString *locations_warehosues =
      [[self URLDictionary] objectForKey:@"locations_warehosues"];
...
- (NSString *)inventory_processing {
  NSString *base = [self baseURL];
  NSString *inventory_processing =
      [[self URLDictionary] objectForKey:@"inventory_processing"];
...
- (NSString *)inventory_list_item {
  NSString *base = [self baseURL];
  NSString *_inventory_list_item =
      [[self URLDictionary] objectForKey:@"inventory_list_item"];
...
- (NSString *)get_positions {
  NSString *base = [self baseURL];
  NSString *get_positionsString =
      [[self URLDictionary] objectForKey:@"get_positions"];
...
- (NSString *)CreateMovementList {
  NSString *base = [self baseURL];
  NSString *create_movement_list =
      [[self URLDictionary] objectForKey:@"create_movement_list"];
...
- (NSString *)GetMovement {
  NSString *base = [self baseURL];
  NSString *get_movement = [[self URLDictionary] objectForKey:@"get_movement"];
  return [base stringByAppendingString:get_movement];
}

- (NSString *)GetMovementDetail {
  NSString *base = [self baseURL];
  NSString *get_movement_detail =
      [[self URLDictionary] objectForKey:@"get_movement_detail"];
  return [base stringByAppendingString:get_movement_detail];
}
...
- (NSString *)getPickById {
    NSString *base = [self baseURL];
    NSString *url =
    [[[self URLDictionary] objectForKey:@"pick"] objectForKey:@"get_by_id"];
